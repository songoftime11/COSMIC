***
      real*8 FUNCTION fallbackM(sne,mc,mt)
*
*     Author : N. Giacobbo
...
*         
         ...
         elseif(2.5d0.le.mc .and. mc.lt.3.5d0)then
            fallbackM = (0.5d0*mc - 1.05d0)/(mt - mproto)
         elseif(3.5d0.le.mc .and. mc.lt.11.d0)then
            fallbackM = alpha_D*mc + beta_D
         elseif(11.d0.le.mc)then
            fallbackM = 1.d0
         endif
*
